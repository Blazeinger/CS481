...
public class napParser extends Parser {
	...
	public final Function_definitionContext function_definition() throws RecognitionException {
		...
		try {
			...
			if (_la==ARROW) {
				...
				match(ARROW);
				setState(36);
				((Function_definitionContext)_localctx).returnType = type();
				}
			}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Bool) | (1L << Int) | (1L << Char) | (1L << String) | (1L << AssignOp) | (1L << FOR) | (1L << WHILE) | (1L << DO) | (1L << IF) | (1L << ARROW) | (1L << LBLOCK) | (1L << SUB) | (1L << NOT) | (1L << LPAR) | (1L << VAR) | (1L << INPUT) | (1L << PRINT) | (1L << NEW) | (1L << Identifier))) != 0)) {
				{
				{
				setState(58);
				statement();
	...
	public final ExpressionsContext expressions() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << Bool) | (1L << Int) | (1L << Char) | (1L << String) | (1L << AssignOp) | (1L << LBLOCK) | (1L << SUB) | (1L << NOT) | (1L << LPAR) | (1L << NEW) | (1L << Identifier))) != 0)) {
				{
				setState(204);
				expr(0);
				setState(209);
	...
	public static final String _serializedATN =
		...
		"\5\24\13\22\u0094\u0095\7/\2\2\u0095\u00b2\5\24\13\16\u0096\u0097\7\t"+
		"\2\2\u0097\u00b2\5\24\13\f\u0098\u0099\7?\2\2\u0099\u009a\7\67\2\2\u009a"+
		...
		"\u00cb\3\2\2\2\u00b3\u00b4\f\24\2\2\u00b4\u00b5\t\3\2\2\u00b5\u00ca\5"+
		"\24\13\25\u00b6\u00b7\f\23\2\2\u00b7\u00b8\t\4\2\2\u00b8\u00ca\5\24\13"+
		"\24\u00b9\u00ba\f\21\2\2\u00ba\u00bb\t\5\2\2\u00bb\u00ca\5\24\13\22\u00bc"+
		"\u00bd\f\20\2\2\u00bd\u00be\7\"\2\2\u00be\u00ca\5\24\13\21\u00bf\u00c0"+
		"\f\17\2\2\u00c0\u00c1\7#\2\2\u00c1\u00ca\5\24\13\20\u00c2\u00c3\f\25\2"+
		"\2\u00c3\u00c4\7\35\2\2\u00c4\u00c5\5\24\13\2\u00c5\u00c6\7\36\2\2\u00c6"+
		"\u00ca\3\2\2\2\u00c7\u00c8\f\r\2\2\u00c8\u00ca\7\t\2\2\u00c9\u00b3\3\2"+
		"\2\2\u00c9\u00b6\3\2\2\2\u00c9\u00b9\3\2\2\2\u00c9\u00bc\3\2\2\2\u00c9"+
		"\u00bf\3\2\2\2\u00c9\u00c2\3\2\2\2\u00c9\u00c7\3\2\2\2\u00ca\u00cd\3\2"+
